...
export default function AdminDashboard() {
  ...
  const stats = {
    pending: approvals.filter((a: PendingApproval) => a.status === 'pending').length,
    approved: approvals.filter((a: PendingApproval) => a.status === 'approved').length,
    rejected: approvals.filter((a: PendingApproval) => a.status === 'rejected').length,
    totalPolice: approvals.filter((a: PendingApproval) => a.type === 'police').length,
    totalLawyer: approvals.filter((a: PendingApproval) => a.type === 'lawyer').length
  }
